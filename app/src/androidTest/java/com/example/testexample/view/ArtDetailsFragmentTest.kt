...
import com.example.testexample.getOrAwaitValue
import com.example.testexample.launchFragmentInHiltContainer
import com.example.testexample.repo.FakeArtRepositoryTest
...
class ArtDetailsFragmentTest {
    ...
    fun testSaveButton(){
        ...
        Espresso.onView(withId(R.id.artistName)).perform(replaceText("Da Vinci"))
